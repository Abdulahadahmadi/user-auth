            ...
            <div class="flex flex-col ju stify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                ...
                <form class="flex flex-col pt-3 md:pt-8" @submit.prevent="FormSubmit">
                    ...
                    <div class="flex flex-col pt-4">
                        ...
                        <input type="tel" id="phone" v-model="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" placeholder="phone" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
                    </div>
