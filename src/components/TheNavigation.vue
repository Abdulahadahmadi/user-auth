<template lang="">
    <div>
        ...
        <div v-show="isAuthenticated" class="ring-1 w-2/6 bg-gray-800 text-white flex my-10 py-5 ">
                <h2 class="text-xl font-bold">User Profile</h2>
                <pre>
                    <img class="rounded-full shadow-xl" src="https://lh3.googleusercontent.com/a-/AFdZucotgLAz3E5ybq2LoZbWs2cbn0wT8b-U56f3G5Hb=s96-c" alt="profile" />
                    <p>{{ user.name }}</p>
                    <p>{{ user.email }}</p>
                </pre>
            </div>
